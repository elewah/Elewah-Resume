...
% multicol removed for ATS compliance
\usepackage{enumitem}
% Packages:
\usepackage[
...
% tabularx/array removed for ATS compliance
...
% paracol removed for ATS compliance
...
\newenvironment{threecolentry}[3][]{
    \onecolentry
    \def\thirdColumn{#3}
    \noindent\begin{minipage}[t]{1.2cm}
        \raggedright #2
    \end{minipage}\hfill%
    \begin{minipage}[t]{\dimexpr\linewidth-6.1cm\relax}
}{
    \end{minipage}\hfill%
    \begin{minipage}[t]{4.5cm}
