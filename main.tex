...
\begin{document}
    ...
    \begin{onecolentry}
 AI Integration Lead and Machine Learning Engineer specializing in designing and deploying scalable AI systems across enterprise and research environments. Currently leading AI and automation integration initiatives at MPAC, modernizing property assessment workflows through LLMs, RAG pipelines, and large vision models. Expertise in blueprint understanding, document intelligence, semantic search, and real-time IoT data frameworks. Proven ability to translate research-grade AI into production-ready systems, aligning technical innovation with organizational KPIs. Strong foundation in software engineering, cloud-native architectures, and cross-functional leadership driving measurable digital transformation.
    \end{onecolentry}
...
\vspace{-0.5cm}
\begin{onecolentry}
\item \textbf{LLM Frameworks \& Tools:} LangChain - LangGraph - LangSmith - RAG - Agentic AI - Docling - MinerU - MCP 
\item \textbf{Programming Languages:} Python - C/C++ - JavaScript
\item \textbf{Web Technologies:} REST APIs - React - HTML - CSS - Bootstrap - FastAPI - Flask
...
\begin{highlights}
    \item Lead enterprise-wide integration of \textbf{AI and automation solutions} across property assessment workflows, modernizing MPAC’s digital infrastructure and operational efficiency.
    \item Architect and implement scalable \textbf{data pipelines} using Python, LangGraph, FastAPI, Docling, MinerU, PostgreSQL, and MCP servers to support intelligent \textbf{building plan parsing and document understanding}.
    \item Design and deploy advanced \textbf{RAG (Retrieval-Augmented Generation)} systems for building plan understanding and semantic search aligned with MPAC assessment standards.
    \item Integrate and optimize \textbf{large vision-language models (e.g., Qwen3-VL,  LayoutLMv3, PaddleOCR-VL, PP-StructureV3)} and other detection and segmentation models such as \textbf{RF-DETR} for architectural object detection, spatial reasoning, document layout understanding, and semantic segmentation.
    \item Lead technical documentation, stakeholder presentations, and cross-team \textbf{knowledge transfer initiatives} to ensure sustainable AI adoption.
\end{highlights}
...
\textbf{Localelive: Agentic Search Engine for Real-Time IoT Data} \href{https://localelive.space/}{Live Demo}  \href{https://www.mdpi.com/1424-8220/25/19/5995}{publication}
\begin{highlights}
    ...
    \item \textbf{Technologies:} FastAPI, Leveraged LangGraph, Tavily API, OpenRouteService, VectorDB, and Sentence-BERT to build a modular and extensible architecture for dynamic IoT data exploration and retrieval.
