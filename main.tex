...
\begin{twocolentry}{
    ...
    \textbf{Artificial Intelligence Integration Lead}, MPAC


\begin{highlights}
    \item Lead enterprise \textbf{AI} and \textbf{automation} integration across \textbf{property assessment} workflows, improving digital operations through production-ready \textbf{AI/ML} systems.
    ...
    \item Design and deploy \textbf{RAG} systems for building plan understanding, retrieval workflows, and assessment-standard knowledge access.
    ...
    \item Integrate a \textbf{Claude agent} into a live \textbf{OpenSearch} cluster hosting \textbf{5.5M+} property records via an \textbf{MCP server} and domain-specific knowledge skills, enabling real-time operational insights and supporting ongoing \textbf{data quality} monitoring.
\end{highlights}
